...
export default function Dashboard() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col justify-center items-center w-full h-screen space-y-8 rounded-xl border border-solid border-border">
                ...
                {isLoading ? <Loader /> : (
                    <div className="space-y-2">
                        ...
                        {!todos?.length ? <p className="text-center">No todos.</p> : (
