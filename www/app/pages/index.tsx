...
import { SiBetterauth, SiBetterauthHex, SiEslint, SiEslintHex, SiGithub, SiHono, SiHonoHex, SiLucide, SiLucideHex, SiReact, SiReactHex, SiReactrouter, SiReactrouterHex, SiShadcnui, SiSharp, SiSharpHex, SiSqlite, SiSqliteHex, SiUnocss, SiUnocssHex, SiVite, SiViteHex } from '@icons-pack/react-simple-icons';
...
export default function Home() {
    ...
    return (
        <main className="size-full">
            ...
            <section className="relative min-h-screen size-screen motion-blur-in motion-duration-[1s]/blur">
                <div
                    ...
                    style={{
                        ...
                        WebkitMaskImage: 'linear-gradient(black 0%, transparent 80%)',
                        maskClip: 'no-clip',
                ...
                >
                    <div className="absolute size-full top-0 inset-0 flex flex-col justify-center op-15 motion-opacity-in-0 motion-duration-2000">
                        <Shaders />
                    </div>

                    <SiVite className={clsx('rotate-12 absolute top-8 -right-50 size-600px', isDark ? 'op-5' : 'text-#646CFF')} />
                    <SiHono className={clsx('rotate-12 absolute top-8 -left-50 size-600px', isDark ? 'op-5' : 'text-#E36002')} />

                    <div
                        className="absolute bottom-0 size-full top-0"
                        style={{
                            background: 'linear-gradient(to bottom, hsl(var(--primary) / 0.07) 10%, transparent 45%)',
                        }}
                    />
                </div>
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center overflow-x-hidden">
                    <div className="flex flex-col items-center text-center">
                        <h1 className={clsx('text-5xl font-800 relative', isDark ? 'bg-gradient-to-b from-foreground to-foreground/50 text-transparent bg-clip-text' : 'text-foreground')}>
                            <span className="text-[180px] uppercase [&_*]:(bg-gradient-to-t from-slate-7 text-transparent bg-clip-text)">
                                <span className="to-#646CFF/30 mr-2">v</span>
                                <span className="to-#3178C6/30">t</span>
                                <span className="to-#E36002/30">h</span>
                            </span>
                            <br />
                        ...
                        <p className="text-2xl font-300 mt-10 max-w-600px text-pretty line-height-relaxed op-80">
                            A full-stack template powered by Vite, Typescript, Hono and React, with a shared, strongly typed codebase for both client and server.
                        </p>

                        <div className="mt-10 flex items-center gap-4 hover:[&>button]:-translate-y-1 [&>button]:(transition-all duration-200 delay-100)">
                            <Link to={{ pathname: 'docs' }}>
                                <Button className="py-6 text-xl min-w-200px bg-gradient-to-br text-shadow-sm from-purple-3 to-blue-4 bg-transparent border-t border-t-white text-white">
                                    Get started
                                </Button>
                            </Link>
                            <Link to={GITHUB}>
            ...
            <section className="mx-auto w-full max-w-5xl space-y-16 px-4 py-8">
                <div className="text-center gap-y-4 flex flex-col items-center">
                    <h2 className="text-5xl font-700 bg-gradient-to-r bg-clip-text from-foreground to-primary text-transparent">Build the framework you want</h2>

                    <p className="text-lg max-w-3xl font-300 line-height-relaxed">
                    ...
                    <div className="flex flex-col">
                        <div className="max-w-xl mt-8">
                            <div className="space-y-2">
                                <h1 className="text-6xl font-700">Using <span className="text-primary">modern</span> tools</h1>
                            ...
                            <Tabs className="my-6" defaultValue="full">
                                ...
                                <TabsContent value="lite">
                                    ...
                                    <div className="mt-2 line-height-relaxed [&_span]:(flex gap-2 items-center)">
                                        <span>
                                    ...
                                    <span className="block mt-4 text-lg">
                                        Learn more about this stack <Link to="/docs/templates/lite" className="hover:underline text-blue-6">here</Link>.
                                    </span>
                                </TabsContent>
                                ...
                                <TabsContent value="full">
                                    ...
                                    <div className="mt-2 line-height-relaxed [&_span]:(flex gap-2 items-center)">
                                        ...
                                        <span>
                                            <SiReactrouter size={16} color={SiReactrouterHex} />
                                            Navigation using <b>vite-plugin-pages</b> and <b>React Router</b>
                                        </span>
                                        <span>
                                    ...
                                    <span className="block mt-4 text-lg">
                                        Learn more about this stack <Link to="/docs/project-structure" className="hover:underline text-blue-6">here</Link>.
                                    </span>
                                </TabsContent>
                            </Tabs>
                        </div>
            ...
            <section className="border-t border-border py-12 flex justify-center">
                <div className="space-y-4">
                    <Link to={GITHUB} className="cursor-pointer duration-200 op-50 hover:op-100">
                        <SiGithub size={28} />
                    </Link>
                </div>
            </section>
